...
def login_button():
    ...
    if entered_username == 'matt' and entered_password == 'pass':
        ...
        invalid_username_label = CTkLabel(root, text="Error. You have entered an invalid username/password or your account has been disabled. Please contact an administrator for further support.")
